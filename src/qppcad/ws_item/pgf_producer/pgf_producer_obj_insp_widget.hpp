#ifndef QPPCAD_PGF_PRODUCER_OBJECT_INSP
#define QPPCAD_PGF_PRODUCER_OBJECT_INSP
...
namespace qpp {
  ...
  namespace cad {
    ...
    class pgf_producer_obj_insp_widget_t final: public ws_item_obj_insp_widget_t {
