...
void app_state_event_disp_t::current_workspace_selected_item_content_changed() {
  app_state_t* astate = app_state_t::get_inst();
  //astate->log("DEBUG: app_state_event_disp_t::current_workspace_selected_item_content_changed()");
  emit(current_workspace_selected_item_content_changed_signal());
}

void app_state_event_disp_t::current_workspace_selected_item_frame_changed() {
  app_state_t* astate = app_state_t::get_inst();
  //astate->log("DEBUG: app_state_event_disp_t::current_workspace_selected_item_frame_changed()");
  emit(current_workspace_selected_item_frame_changed_signal());
}

void app_state_event_disp_t::current_workspace_selected_atoms_list_selection_changed() {
   emit(current_workspace_selected_atoms_list_selection_changed_signal());
}

void app_state_event_disp_t::current_workspace_selected_atoms_list_cell_changed() {
