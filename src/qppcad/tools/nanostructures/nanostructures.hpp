#ifndef QPPCAD_TOOL_NANOSTRUCTURES
#define QPPCAD_TOOL_NANOSTRUCTURES
...
namespace qpp {
  ...
  namespace cad {
    ...
    class nanostructures_widget_t : public ws_item_inline_tool_widget_t,
	...
	nanostructures_widget_t(QWidget *parent = nullptr);
    ...
    class nanostructures_tool_t : public ws_item_tool_t {
