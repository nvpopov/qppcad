...
#include <qppcad/geom_view/geom_view_render_bs.hpp>
...
geom_view_t::geom_view_t(): ws_item_t () {
  ...
  m_measure = std::make_unique<geom_view_measurement_subsys_t>(*this);
...
std::string geom_view_t::compose_item_name () {
  return fmt::format("geom. view, DIM = [{}d]", m_geom->DIM);
}
