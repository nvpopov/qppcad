#include <qppcad/geom_view/geom_view_render_buffered_billboards.hpp>
...
namespace qpp {
  ...
  namespace cad {
    ...
    geom_view_render_buffered_billboards_t::geom_view_render_buffered_billboards_t(
        geom_view_t &_p_owner){
       p_owner = &_p_owner;
    }

    void geom_view_render_buffered_billboards_t::init () {
...
//      m_tb_color_s->init();
    ...
    void geom_view_render_buffered_billboards_t::render () {
