...
TEST_CASE("history stream test") {
  ...
  SECTION ("basic features") {
    ...
    REQUIRE(hs->set_cur_epoch(2) == hs_result_e::hr_invalid_epoch);
    REQUIRE(hs->get_cur_epoch() == 0);

    REQUIRE(std::get<0>(hs->push_epoch(1)) == hs_result_e::hr_success);
    REQUIRE(hs->checkout_to_epoch(1) == hs_result_e::hr_success);
    REQUIRE(std::get<0>(hs->push_epoch(2)) == hs_result_e::hr_success);
    ...
    REQUIRE(std::get<0>(hs_c1->push_epoch(1)) == hs_result_e::hr_success);
    REQUIRE(hs_c1->checkout_to_epoch(0) == hs_result_e::hr_success);

    REQUIRE(std::get<0>(hs_c2->push_epoch(1)) == hs_result_e::hr_success);
    REQUIRE(hs_c2->checkout_to_epoch(0) == hs_result_e::hr_success);

    REQUIRE(hs->checkout_to_epoch(0) == hs_result_e::hr_success);
    ...
    REQUIRE(hs->augment_epoch(1, hs_c1, 2) == hs_result_e::hr_invalid_child_epoch);
  ...
  SECTION ("basic features 2") {
    ...
    REQUIRE(hs->checkout_to_epoch(1) == hs_result_e::hr_success);
    REQUIRE(std::get<0>(hs->push_epoch(2)) == hs_result_e::hr_success);
    REQUIRE(hs->checkout_to_epoch(2) == hs_result_e::hr_success);
    REQUIRE(std::get<0>(hs->push_epoch(3)) == hs_result_e::hr_success);
    REQUIRE(hs->checkout_to_epoch(3) == hs_result_e::hr_success);
    REQUIRE(std::get<0>(hs->push_epoch(4)) == hs_result_e::hr_success);
    REQUIRE(hs->checkout_to_epoch(4) == hs_result_e::hr_success);
    ...
    REQUIRE(hs->add_hs_child(hs_c1) == hs_result_e::hr_success);
    REQUIRE(hs->add_hs_child(hs_c2) == hs_result_e::hr_success);
    REQUIRE(hs->add_hs_child(nullptr) == hs_result_e::hr_invalid_child);
  ...
  SECTION("Deep nested structure") {
    ...
    REQUIRE(std::get<0>(hs->push_epoch(1)) == hs_result_e::hr_success);
    REQUIRE(std::get<0>(hs_c1->push_epoch(1)) == hs_result_e::hr_success);
    REQUIRE(std::get<0>(hs_c1_c1->push_epoch(1)) == hs_result_e::hr_success);
    REQUIRE(std::get<0>(hs_c1_c2->push_epoch(1)) == hs_result_e::hr_success);
    REQUIRE(std::get<0>(hs_c2->push_epoch(1)) == hs_result_e::hr_success);
    REQUIRE(std::get<0>(hs_c3->push_epoch(1)) == hs_result_e::hr_success);
  ...
  SECTION ("testing history cleanup") {
    ...
    REQUIRE(std::get<0>(hs1->push_epoch()) == hs_result_e::hr_success);
    REQUIRE(hs1->checkout_to_epoch(1) == hs_result_e::hr_success);
    REQUIRE(hs1->get_cur_epoch() == 1);

    REQUIRE(std::get<0>(hs1->push_epoch()) == hs_result_e::hr_success);
    REQUIRE(hs1->checkout_to_epoch(2) == hs_result_e::hr_success);
    REQUIRE(hs1->get_cur_epoch() == 2);

    REQUIRE(std::get<0>(hs1->push_epoch()) == hs_result_e::hr_success);
    REQUIRE(hs1->checkout_to_epoch(3) == hs_result_e::hr_success);
  ...
  SECTION ("hist doc test") {
    ...
    REQUIRE(hsi1->checkout_to_epoch(1) == hs_result_e::hr_success);
    REQUIRE(hsi1->push_epoch_with_value(3) == hs_result_e::hr_success);
    REQUIRE(hsi1->checkout_to_epoch(2) == hs_result_e::hr_success);
    REQUIRE(hsi1->push_epoch_with_value(4) == hs_result_e::hr_success);
    REQUIRE(hsi1->checkout_to_epoch(3) == hs_result_e::hr_success);
    ...
    REQUIRE(hsv1->checkout_to_epoch(1) == hs_result_e::hr_success);
  ...
  SECTION ("testing epoch cursor") {
    ...
    REQUIRE(std::get<0>(hs->push_epoch(5)) == hs_result_e::hr_success);
    REQUIRE(hs->checkout_to_epoch(5) == hs_result_e::hr_success);

    REQUIRE(hs->get_history() == std::vector<epoch_t>{0, 1, 2, 5});
    REQUIRE(hs->get_history_size() == 4); //counts 0, 1, 2, 5

    REQUIRE(std::get<0>(hs->push_epoch(3)) == hs_result_e::hr_invalid_epoch);
    REQUIRE(hs->checkout_to_epoch(2) == hs_result_e::hr_success);
    REQUIRE(std::get<0>(hs->push_epoch(6)) == hs_result_e::hr_success);
  ...
  SECTION ("nested elem deletions") {
    ...
    REQUIRE(std::get<0>(hs_c1->push_epoch(1)) == hs_result_e::hr_success);
    REQUIRE(hs_c1->checkout_to_epoch(1) == hs_result_e::hr_success);
    REQUIRE(hs_c1->get_cur_epoch() == 1);

    REQUIRE(std::get<0>(hs_c1->push_epoch(2)) == hs_result_e::hr_success);
    REQUIRE(hs_c1->checkout_to_epoch(2) == hs_result_e::hr_success);
    REQUIRE(hs_c1->get_cur_epoch() == 2);

    hist_doc_base_t *hs_c2 = new hist_doc_base_t;
    REQUIRE(std::get<0>(hs_c2->push_epoch(1)) == hs_result_e::hr_success);
    REQUIRE(std::get<0>(hs_c2->push_epoch(2)) == hs_result_e::hr_success);
    ...
    REQUIRE(hs->remove_child(hs_c1) == hs_result_e::hr_success);
    REQUIRE(hs->remove_child(hs_c2) == hs_result_e::hr_success);
  ...
  SECTION ("nested elem deletions") {
    ...
    hist_doc_base_t *hs = new hist_doc_base_t;
    REQUIRE(std::get<0>(hs->push_epoch(std::nullopt, true)) == hs_result_e::hr_success);
    REQUIRE(std::get<0>(hs->push_epoch(std::nullopt, true)) == hs_result_e::hr_success);
    REQUIRE(std::get<0>(hs->push_epoch(std::nullopt, true)) == hs_result_e::hr_success);
    REQUIRE(std::get<0>(hs->push_epoch(std::nullopt, true)) == hs_result_e::hr_success);
  ...
  SECTION ("nested elem deletions") {
    ...
    hsi1->set_value(10);
    REQUIRE(hsi1->commit_exclusive() == hs_result_e::hr_success);
  ...
  SECTION ("nested elem exclusive commit") {
    ...
    REQUIRE(hs_root->add_hs_child(hs_el1) == hs_result_e::hr_success);
    REQUIRE(hs_el1->add_hs_child(hs_el2) == hs_result_e::hr_success);
    REQUIRE(hs_el2->add_hs_child(hsi1) == hs_result_e::hr_success);
    ...
    REQUIRE(hs_root->checkout_to_epoch(1) == hs_result_e::hr_success);
    REQUIRE(hs_el1->get_cur_epoch() == 1);
    REQUIRE(hs_el2->get_cur_epoch() == 1);
    REQUIRE(hsi1->get_cur_epoch() == 2);
    REQUIRE(hsi1->get_value() == 20);

    REQUIRE(hs_root->checkout_to_epoch(2) == hs_result_e::hr_success);
    REQUIRE(hs_el1->get_cur_epoch() == 2);
    REQUIRE(hs_el2->get_cur_epoch() == 2);
    REQUIRE(hsi1->get_cur_epoch() == 3);
    REQUIRE(hsi1->get_value() == 30);

    REQUIRE(hsi1->commit_value_exclusive(44) == hs_result_e::hr_success);
    REQUIRE(hs_root->get_cur_epoch() == 3);
    REQUIRE(hsi1->commit_value_exclusive(45) == hs_result_e::hr_success);
  ...
  SECTION ("nested elem addition vol2") {
    ...
    REQUIRE(std::get<0>(hs_root->push_epoch(std::nullopt, true)) == hs_result_e::hr_success);
    REQUIRE(std::get<0>(hs_root->push_epoch(std::nullopt, true)) == hs_result_e::hr_success);
    REQUIRE(std::get<0>(hs_root->push_epoch(std::nullopt, true)) == hs_result_e::hr_success);

    REQUIRE(hs_root->add_hs_child(hs_el1) == hs_result_e::hr_success);
    REQUIRE(hs_root->add_hs_child(hs_el2) == hs_result_e::hr_success);

    REQUIRE(hs_root->is_child_alive(0, hs_el1) == hs_result_e::hr_false);
    REQUIRE(hs_root->is_child_alive(1, hs_el1) == hs_result_e::hr_false);
    REQUIRE(hs_root->is_child_alive(2, hs_el1) == hs_result_e::hr_false);
    REQUIRE(hs_root->is_child_alive(3, hs_el1) == hs_result_e::hr_true);

    REQUIRE(hs_root->is_child_alive(0, hs_el2) == hs_result_e::hr_false);
    REQUIRE(hs_root->is_child_alive(1, hs_el2) == hs_result_e::hr_false);
    REQUIRE(hs_root->is_child_alive(2, hs_el2) == hs_result_e::hr_false);
    REQUIRE(hs_root->is_child_alive(3, hs_el1) == hs_result_e::hr_true);
    ...
    REQUIRE(hs_root->is_child_alive(2, hs_el1) == hs_result_e::hr_false);
    REQUIRE(hs_root->is_child_alive(3, hs_el1) == hs_result_e::hr_true);
    REQUIRE(hs_root->is_child_alive(4, hs_el1) == hs_result_e::hr_true);
    REQUIRE(hs_root->is_child_alive(5, hs_el1) == hs_result_e::hr_true);

    REQUIRE(hs_root->is_child_alive(0, hs_el2) == hs_result_e::hr_false);
    REQUIRE(hs_root->is_child_alive(1, hs_el2) == hs_result_e::hr_false);
    REQUIRE(hs_root->is_child_alive(2, hs_el2) == hs_result_e::hr_false);
    REQUIRE(hs_root->is_child_alive(3, hs_el2) == hs_result_e::hr_true);
    REQUIRE(hs_root->is_child_alive(4, hs_el2) == hs_result_e::hr_true);
    REQUIRE(hs_root->is_child_alive(5, hs_el2) == hs_result_e::hr_true);
    ...
    REQUIRE(hs_root->reset() == hs_result_e::hr_success);
    REQUIRE(hs_el1->is_unmodified() == true);
    REQUIRE(hs_el2->is_unmodified() == true);
    REQUIRE(hs_root->is_unmodified() == true);
  ...
  SECTION ("record test") {
    ...
    REQUIRE(hs_it1->add_hs_child(hs_el1) == hs_result_e::hr_success);
    REQUIRE(hs_it1->add_hs_child(hs_el2) == hs_result_e::hr_success);
    ...
    REQUIRE(hs_root->add_hs_child(hs_it1) == hs_result_e::hr_success);
