...
namespace qpp::cad {
  ...
  struct ws_atoms_list_render_bs {
      ...
      static void render_atom(ws_atoms_list_t &al,
        ...
        if (ap_idx) {
            dr_rad = ptable::get_inst()->arecs[*ap_idx-1].aRadius * al.m_atom_scale_factor;
        ...
        al.app_state_c->dp->render_atom(color, al.m_geom->pos(at_num, at_index) + al.m_pos, dr_rad);
      }
      ...
      static void render_bond(ws_atoms_list_t &al,
        ...
        al.app_state_c->dp->render_bond(bcolor, al.m_geom->pos(at_num1, at_index1) + al.m_pos,
